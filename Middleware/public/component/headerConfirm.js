...
//     <img style="height: 100px;" src="https://fpt.com/-/media/project/fpt-corporation/fpt/common/images/navigation/logo/fpt-logo.svg">
//   </div>
//   <div class="d-flex flex-row mx-3">
//     <div class="mx-3 align-middle my-auto">
//       <img style="height: 60px; width: 60px; margin-right:50px; border-radius: 50%; object-fit: cover" src="" alt="profile picture" id="image">
//     </div>
//     <div class="d-flex flex-column">
//       <div class="flex-grow-1 fw-bold fs-5 text-white text-center"></div>
